...
<body>
	...
	<div class="header">
		...
		</div>	<div class="banner wow fadeInUp" data-wow-delay="0.4s" id="Home">
		    <div class="container">
						...
						<div class="top-cuisine-grid wow bounceIn" data-wow-delay="0.4s">
							<?php
								if (file_exists('bdd.xml')) {
    								...
    								echo "<a href = '".$xml->Video[$i]->URL."'target='blank'><img src='http://images.commeaucinema.com/news/208_259307.jpg' /></a>";
									echo "<script>$('img:eq(7)').attr('class', 'img-responsive')</script>";
									echo "<label>Being Human</label>";
								}
							?>
					    </div>
						<div class="top-cuisine-grid wow bounceIn" data-wow-delay="0.4s">
						    <?php
								if (file_exists('bdd.xml')) {
    								...
    								echo "<a href = '".$xml->Video[$i]->URL."'target='blank'><img src='".$xml->Video[$i]->URLPhoto."' /></a>";
									echo "<script>$('img:eq(8)').attr('class', 'img-responsive')</script>";
									echo "<label>".$xml->Video[$i]->Title."</label>";
								}
							?>
					    </div>
						<div class="top-cuisine-grid wow bounceIn" data-wow-delay="0.4s">
						    <?php
								if (file_exists('bdd.xml')) {
    								...
    								echo "<a href = '".$xml->Video[$i]->URL."'target='blank'><img src='http://img3.wikia.nocookie.net/__cb20120617213531/breakingbad/images/4/47/Season_1_AMC_Poster.jpg' /></a>";
									echo "<script>$('img:eq(9)').attr('class', 'img-responsive')</script>";
									echo "<label>Breaking Bad</label>";
								}
							?>
					    </div>
			...
			<div class="service-section-bottom-row">
				<div class="container">
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						<div class="icon">
							<a href="http://www.prep-etna.fr/" target="blank"><img src="images/icon1.jpg" class="img-responsive" alt="" /></a>
						</div>
						<div class="icon-data">
							<h4>Etna</h4>
					...
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						<div class="icon">
							<a href="http://www.hadopi.fr/" target="blank"><img src="images/icon2.jpg" class="img-responsive" alt="" /></a>
						</div>
						<div class="icon-data">
							<h4>Hadopi</h4>
					...
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						<div class="icon">
							<a href="http://blogs.ionis-group.com/etna/blogs/2014/01/vainqueurs-premiers-code-camps-prepetna.php" target="blank"><img src="images/icon3.jpg" class="img-responsive" alt="" /></a>
						</div>
						<div class="icon-data">
							<h4>Code Camp</h4>
