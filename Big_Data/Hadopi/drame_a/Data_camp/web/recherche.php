						    	...
						    	<?php
										...
										if (isset($_POST['film']))
									{
											...
											for ($i = $debut_film; $i < $fin_film; ++$i)
											{
												...
												{
													echo "<a href = ".$xml->Video[$i]->URL."><img src='".$xml->Video[$i]->URLPhoto."'/></a>";
													echo "<a href = ".$xml->Video[$i]->URL."><label>";
													echo $xml->Video[$i]->Title;
													echo "</label></a><br />";
									...
									<div style="margin-left: 400px" class="img-responsive">
									<p  style="color: blue">
								...
								<?php
										...
										if (isset($_POST['film']))
											...
											for ($i = $debut_film; $i < $fin_film; ++$i)
											{
												...
												if($film_search == $_POST['film'])
												{
													echo $xml->Video[$i]->Categories->Category."<br /><br />";
													echo $xml->Video[$i]->Plot."<br />";
													echo $xml->Video[$i]->Duration;
