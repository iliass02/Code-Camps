...
elseif (isset($_GET['erreur'])) $erreur = $_GET['erreur'];
else exit();
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="container">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Vous êtes deja inscrit</h3>
          	...
          	switch($erreur) {
          		...
          		case 1:
          			...
          			echo "<h3><a href='javascript:history.back()'>Cliquez pour recommencer</a></h3>";
          			echo "<h3><a href='login.php'>Sinon connectez-vous !</a></h3>";
